        ...
        <div className="grid gap-8 lg:grid-cols-[1.3fr_1fr]">
          <Reveal className="glass rounded-3xl p-7 sm:p-10">
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <button
                type="submit"
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-violet-500 via-cyan-400 to-pink-500 px-6 py-3.5 text-sm font-semibold text-black transition-transform hover:scale-105"
              >
                Send Message
              ...
              {sent && (
                <p className="text-sm text-emerald-300">
                  Your email app should now be open with your message pre-filled — just hit send. Prefer not to?
                  Email us directly at hello@projectx.dev.
                </p>
              )}
            </form>
          </Reveal>
